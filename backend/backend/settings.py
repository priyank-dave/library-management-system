...
SECRET_KEY = "django-insecure-=o6yfx(47eb#d^d97q4vxn!+e3^m*_%n_od0tzt@&q5vpn0##x"
...
DATABASES = {
    "default": {
        ...
        "NAME": "library_db",  # Change to your MySQL database name
        "USER": "root",  # Change to your MySQL username
        "PASSWORD": "Security*()sec1",  # Change to your MySQL password
